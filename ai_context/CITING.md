...
The DOI `10.5281/zenodo.18604845` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
