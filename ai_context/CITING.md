...
> Brooke, E. S. (2026). *Admissibility Constraints and Structural Saturation*. Version v2.0. Zenodo. https://doi.org/10.5281/zenodo.18439397

**BibTeX:**

```bibtex
@misc{brooke_paper4_2026,
  ...
  url          = {https://doi.org/10.5281/zenodo.18439397}
}
```

The DOI `10.5281/zenodo.18439397` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
