# PAPER_LINEAGE.md — Version History for Paper 4

This file tracks the version history of Paper 4 (Admissibility Constraints and Structural Saturation) and explains the relationship between the version in this release, the version on Zenodo, and any intermediate versions.
...
- **File in this repo:** `Paper_4_Admissibility_Constraints_Field_Content_v2.0.tex` + `.pdf`
- **Page count:** 39 pp
...
- **Concept DOI:** 10.5281/zenodo.18439397
...
- **v2.0** (current): see the main paper's changelog section for details.
...
**vv2.0 supersedes all earlier versions** for current reference. If citing for strict reproducibility of work published before this version, cite the version DOI from the specific Zenodo deposit the earlier work used.
...
*Generated by `create-repo`. The `- **v2.0** (current): see the main paper's changelog section for details.
