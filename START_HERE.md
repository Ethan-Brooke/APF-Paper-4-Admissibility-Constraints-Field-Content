...
You are reading the companion to **Paper 4** (this repo: https://github.com/Ethan-Brooke/APF-Paper-4-Admissibility-Constraints-Field-Content). The canonical computational engine lives at codebase **v6.9** ([Zenodo](https://doi.org/10.5281/zenodo.18604548)). Each paper has its own companion repo following the same layout.
